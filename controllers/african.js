...
const getAllData = async (req, res, next) => {
  //#swagger.tags = ['african']
  try {
    const result = await mongodb.getDb().db('cse341_personal').collection('african').find();
...
const getData = async (req, res) => {
  ...
  try {
    ...
    const result = await mongodb.getDb().db('cse341_personal').collection('african').find({ _id: id });
    const lists = await result.toArray();
...
const createData = async (req, res, next) => {
  ...
  try {
    ...
    const response = await mongodb.getDb().db('cse341_personal').collection('african').insertOne(recipe);
...
const updateData = async (req, res, next) => {
  ...
  try {
    ...
    const response = await mongodb.getDb().db('cse341_personal').collection('african').replaceOne({ _id: id }, recipe);
...
const deleteData = async (req, res, next) => {
  ...
  try {
    ...
    const id = new ObjectId(req.params.id);
    const response = await mongodb.getDb().db('cse341_personal').collection('african').deleteOne({ _id: id });
